...
Thirdparty elements are missing, such as fonts/images. </br> To install dependencies, run `chmod +x dependencies.sh && sudo ./dependencies.sh` as sudo to install automatically.
